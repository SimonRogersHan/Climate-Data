...
# (Uncomment install.packages() lines if packages are not already installed)
...
X <- data[, c("tempmax", "CDD", "humidity", "dew", "cloudcover", "precip", "windspeed", "solarenergy",
              "CDD_Lag1", "CDD_Lag2", "heatwave_humidity_interaction", "cloudcover_Lag1", "humidity_Lag1",
              "heatwave_flag_solarenergy", "tempmax_cloudcover", "temp_Lag1", "temp_Lag2"
)]
